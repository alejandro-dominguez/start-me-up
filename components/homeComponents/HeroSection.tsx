...
const HeroSection = ({ searchBarQuery }: { searchBarQuery?: string | '' }) => {
    return (
        ...
        pt-8 pb-[1.125rem] xs:pt-[3.2rem] xs:pb-9 px-3 md:px-6 shadow-sm'>
            ...
            <h2 className='font-medium text-xl md:text-[1.4rem] text-white max-w-3xl
            text-center break-words mt-2 xs:mt-3 drop-shadow leading-6 md:leading-7'>
